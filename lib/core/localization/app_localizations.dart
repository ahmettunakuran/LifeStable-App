...
class S {
  ...
  static final Map<String, Map<String, String>> _data = {
    'en': {
      ...
      'leave_team_confirm_title': 'Leave Team',
      'leave_team_confirm_body': 'Are you sure you want to leave this team?',
      'delete_team_confirm_title': 'Delete Team',
      'delete_team_confirm_body': 'This will permanently delete the team and remove all members. Are you sure?',
      'leave': 'Leave',
      'new_invite_code_generated': 'New invite code generated!',
      ...
      'transfer_ownership_confirm_body': 'You will become an admin. The selected user will become the new owner.',
      'transfer_btn': 'Transfer',
      'new_team_task': 'New Team Task',
      ...
      'invite_code_instructions': 'Enter the 8-digit code from your team leader.',
      'joined_team_success': 'Successfully joined the team!',
      'join_btn': 'Join',
      // Habits Tracker
      'habit_name_label': 'Habit Name',
      'enter_habit_name_tooltip': 'Enter a short, actionable habit name.',
      'link_to_domain_label': 'Link to Domain:',
      'new_habit': 'New Habit',
      'delete_habit_title': 'Delete Habit',
      'delete_habit_body': '"{name}" will be deleted. Are you sure?',
      'health_guardrail': '⏸ Health Guardrail',
      'pause_habit_instructions': 'Pausing a habit protects your streak during stressful periods.',
      'today_habits_completed': 'TODAY • {done} OF {total} DONE',
      'current_streak_title': 'CURRENT STREAK',
      'done_today_streak_subtitle': '{done} of {total} habits done today',
      ...
      'tap_map_to_pin': 'Tap on the map to pin a location',
      ...
      'label_hint': 'Label (e.g. School, Gym, Market)',
      'dont_remind_after': 'Don\'t remind after',
      'not_set': 'Not set',
      'save_location': 'Save Location',
      'search_error_not_found': 'Address not found. Try a different query.',
      'pick_location_warning': 'Please search or pick a location first.',
      'enter_label_warning': 'Please enter a label.',
      'edit_location': 'Edit Location',
      'radius_meters': '{radius} m radius',
      'no_saved_locations': 'No saved locations yet.\nTap the map to add one.',
      'delete_location_confirm_title': 'Delete Location',
      'delete_location_confirm_body': 'Remove "{label}" from saved locations?',
    ...
    'tr': {
      ...
      'leave_team_confirm_title': 'Takımdan Ayrıl',
      'leave_team_confirm_body': 'Bu takımdan ayrılmak istediğine emin misin?',
      'delete_team_confirm_title': 'Takımı Sil',
      'delete_team_confirm_body': 'Bu işlem takımı kalıcı olarak silecek ve tüm üyeleri çıkaracaktır. Emin misin?',
      'leave': 'Ayrıl',
      'new_invite_code_generated': 'Yeni davet kodu oluşturuldu!',
      'member_actions': 'Üye İşlemleri',
      'make_admin': 'Yönetici Yap',
      'remove_admin': 'Yöneticiliği Kaldır',
      'transfer_ownership': 'Kuruculuğu Devret',
      'remove_from_team': 'Takımdan Çıkar',
      'transfer_ownership_confirm_title': 'Kuruculuğu Devret',
      'transfer_ownership_confirm_body': 'Yönetici olacaksınız. Seçilen kullanıcı yeni kurucu olacaktır.',
      'transfer_btn': 'Devret',
      'new_team_task': 'Yeni Takım Görevi',
      'task_title': 'Görev Başlığı',
      'description_label': 'Açıklama',
      'assign_to': 'Atanan Kişi',
      ...
      'task_conflict_msg': 'Çakışma algılandı — başka bir üye bu görevi güncelledi. Yenilemek için kaydırın.',
      'no_tasks_team': 'Bu takım için görev bulunamadı.',
      'join_team': 'Takıma Katıl',
      'enter_invite_code': 'Davet Kodunu Gir',
      'invite_code_instructions': 'Takım liderinden aldığın 8 haneli kodu gir.',
      'joined_team_success': 'Takıma başarıyla katıldın!',
      'join_btn': 'Katıl',
      // Habits Tracker
      'habit_name_label': 'Alışkanlık Adı',
      'enter_habit_name_tooltip': 'Kısa ve uygulanabilir bir alışkanlık adı girin.',
      'link_to_domain_label': 'Alana Bağla:',
      'new_habit': 'Yeni Alışkanlık',
      'delete_habit_title': 'Alışkanlığı Sil',
      'delete_habit_body': '"{name}" silinecek. Emin misiniz?',
      'health_guardrail': '⏸ Sağlık Koruyucu',
      'pause_habit_instructions': 'Bir alışkanlığı duraklatmak, stresli dönemlerde serinizi korur.',
      'today_habits_completed': 'BUGÜN • {total} ALANDAN {done} TAMAMLANDI',
      'current_streak_title': 'MEVCUT SERİ',
      'done_today_streak_subtitle': 'Bugün {total} alışkanlıktan {done} tanesi tamamlandı',
      'last_30_days': 'SON 30 GÜN',
      'paused_suffix': 'Duraklatıldı',
      'resume': 'Devam Et',
      'pause': 'Duraklat',
      'daily': 'Günlük',
      // Locations & Geofence
      ...
      'tap_map_to_pin': 'Konum işaretlemek için haritaya dokunun',
      ...
      'label_hint': 'Etiket (örn. Okul, Spor Salonu, Market)',
      'dont_remind_after': 'Şu saatten sonra hatırlatma',
      'not_set': 'Ayarlanmadı',
      'save_location': 'Konumu Kaydet',
      'search_error_not_found': 'Adres bulunamadı. Farklı bir arama deneyin.',
      'pick_location_warning': 'Lütfen önce arama yapın veya bir konum seçin.',
      'enter_label_warning': 'Lütfen bir etiket girin.',
      'edit_location': 'Konumu Düzenle',
      'radius_meters': '{radius} m yarıçap',
      'no_saved_locations': 'Henüz kayıtlı konum yok.\nEklemek için haritaya dokunun.',
      'delete_location_confirm_title': 'Konumu Sil',
      'delete_location_confirm_body': '"{label}" kayıtlı konumlardan kaldırılsın mı?',
