    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setStateDialog) => AlertDialog(
          ...
          title: const Text(
            'New Habit',
            style: TextStyle(color: AppColors.gold, fontWeight: FontWeight.w900, fontSize: 16),
          ),
          content: Column(
  ...
  void _confirmDelete(Habit habit) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          '"${habit.name}" will be deleted. Are you sure?',
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: paused ? Colors.white38 : AppColors.gold,
                ),
              ),
            ],
          ),
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                    color: paused ? Colors.white38 : Colors.white,
                    decoration: paused ? TextDecoration.lineThrough : TextDecoration.none,
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 11,
                    color: paused ? Colors.white24 : Colors.white54,
                  ),
                ),
              ],
            ),
            ...
            children: [
              IconButton(
                ...
                icon: Icon(
                  Icons.check_circle,
                  size: 22,
                  color: doneToday ? Colors.greenAccent : Colors.white24,
                ),
                onPressed: doneToday || paused ? null : () => _completeHabit(habit),
              ),
              IconButton(
                constraints: const BoxConstraints(),
                padding: const EdgeInsets.all(6),
                icon: Icon(
                  ...
                  size: 22,
                  color: paused ? AppColors.gold : Colors.white54,
                ),
      ...
      child: SafeArea(
        child: Row(
          ...
          children: [
            ...
            _navBtn(context, Icons.local_fire_department_outlined, 'Habit', AppRoutes.habitTracker, active: true),
          ],
        ),
      ),
    );
