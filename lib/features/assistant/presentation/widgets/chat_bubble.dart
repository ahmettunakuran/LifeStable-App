...
import 'package:project_lifestable/features/assistant/logic/assistant_cubit.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          // Primary row: confirm anyway / lighter day
          Row(
            children: [
              Expanded(
          ...
          // Secondary row: auto-rescheduling (WP5.3)
          SizedBox(
...
class _ScheduleScopePanel extends StatelessWidget {
  ...
  final String messageId;
  const _ScheduleScopePanel(
      {required this.pending, required this.messageId});
